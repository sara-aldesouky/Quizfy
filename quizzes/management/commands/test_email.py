...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"[ERROR] Error checking sites: {redact(type(e).__name__)}"))
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"[ERROR] Error sending email: {redact(type(e).__name__)}"))
